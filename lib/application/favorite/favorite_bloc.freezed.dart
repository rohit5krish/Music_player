...
mixin _$FavoriteState {
  ...
  List<Audio> get finalFavSongs => throw _privateConstructorUsedError;
...
abstract class $FavoriteStateCopyWith<$Res> {
  ...
  $Res call({List<audioModel> favSongList, List<Audio> finalFavSongs});
}
...
class _$_FavoriteState implements _FavoriteState {
  ...
  @override
  String toString() {
    return 'FavoriteState(favSongList: $favSongList, finalFavSongs: $finalFavSongs)';
  }
...
abstract class _FavoriteState implements FavoriteState {
  const factory _FavoriteState(
      {required final List<audioModel> favSongList,
      required final List<Audio> finalFavSongs}) = _$_FavoriteState;
